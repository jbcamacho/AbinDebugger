"""
Given an integer, this benchmark runs the DeltaBlue Algorithm.
...
@misc{python-pyperformance,
  ...
  url = {https://github.com/python/pyperformance/tree/main/pyperformance/data-files/benchmarks/bm_deltablue}
}
...
class EqualityConstraint(BinaryConstraint):
    ...
    def execute(self):
        self.output().value = self.input2().value
...
def chain_test(n: int = 0) -> Tuple:
    ...
    for i in range(100):
        first.value = n # <-- FIX first.value = i
        plan.execute()
