"""
Given an integer x, this benchmark solves a Hexiom board game.
...
@misc{python-pyperformance,
  ...
  url = {https://github.com/python/pyperformance/tree/main/pyperformance/data-files/benchmarks/bm_hexiom}
}
"""
...
def aMain1(level, loops: int = 1):
    ...
    board = board.strip()
    expected = solution.lstrip() # <-- FIX expected = solution.rstrip()
